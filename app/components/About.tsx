...
export default function About() {
  ...
  return (
    <section id="about" className="py-24 px-6 md:px-10 max-w-7xl mx-auto border-t border-white/5 relative z-10 bg-black">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-16">
        ...
        <div className="md:col-span-9 font-body">
          <h2 className="font-heading text-4xl md:text-5xl lg:text-7xl font-extrabold text-white mb-8 leading-tight tracking-tight">
            We satisfyingly ruined it for everyone.
          </h2>
          
          <div className="space-y-6 text-lg md:text-xl text-white/70 font-light leading-relaxed max-w-3xl">
            <p>
            ...
            <p>
              Turns out, when you set the bar, everyone suddenly discovers they wanted to do hackathons too. Startups started hosting their own, other communities followed, and just like that — a full-blown <strong className="font-semibold text-white">Hackathon Fever</strong>.
            </p>
            <p>
              We kept raising the bar every year, and here we are again: <strong className="font-semibold text-white">bigger sponsors, bigger prizes, bigger challenges</strong>. But the core hasn't changed — community, connections, and most importantly, having fun.
            </p>
          ...
          <div className="mt-16 md:mt-24 space-y-6">
            {/* Image Container */}
            <div className="relative w-full aspect-[16/9] md:aspect-[21/9] bg-white/5 rounded-3xl overflow-hidden shadow-2xl">
            ...
            <div className="flex items-center justify-between mt-6">
              <span className="text-white/50 text-sm font-medium">Previous edition</span>
              
              <div className="flex-1 mx-6 flex items-center relative">
                {/* Progress bar background */}
                <div className="h-0.5 w-full bg-white/20 rounded-full overflow-hidden relative">
                  {/* Progress bar fill */}
                  <div 
              ...
              <div className="flex items-center gap-4">
                ...
                >
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="text-white/70 group-hover:text-white transition-colors">
